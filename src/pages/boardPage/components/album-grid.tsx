// AlbumGrid provides shelf refs; overlay rect computation moved to OverlayContext
...
interface AlbumGridProps {
  ...
  screenWidth: number;
  currentPage: number;
  // layout helpers are registered via OverlayRegistrar / OverlayContext
}
...
export function AlbumGrid({
  ...
  // AlbumGrid no longer dispatches CustomEvents; the OverlayContext computes
  // and provides album/link/lp rects centrally. This component simply
  // provides refs (shelfRef/shelfWrapperRef) via the registrar.
